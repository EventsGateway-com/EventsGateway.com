export const pricingContent = {
  ...
  title: "Start free. Pay only as your monthly events grow.",
  intro:
    "The Free plan includes up to 1,000,000 events per month. After that, usage is billed in flat 1,000,000-event blocks at $5 each. Enterprise is available for teams that need onboarding, support, or policy controls.",
  plans: [
    {
      name: "Free",
      price: "$0",
      cadence: "/ month",
      highlight: "Up to 1,000,000 monthly events",
      features: [
    ...
    },
    {
      ...
      highlight: "Linear pricing, no plan cliff",
      features: [
        "Each additional 1,000,000-event block adds $5",
        "Scale from early traction to high-volume growth teams",
  ...
  included: [
    ...
    "A pricing model that starts free and scales with your event volume",
  ...
  footnotes: [
    "The free allowance covers up to 1,000,000 events in a calendar month.",
